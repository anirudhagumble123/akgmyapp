...
<html lang="en">
  <head>
      <meta charset="utf-8">
      <title>Upload Document details</title>
 ...
 <body>
    ...
    <spring:bind path="id">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="id" class="form-control" placeholder="ID" readonly>
                    </form:input>
    ...
    <spring:bind path="documentname">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="documentname" class="form-control" placeholder="Document name" autofocus="true">
                    </form:input>
    ...
    <spring:bind path="documenttype">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="documenttype" class="form-control" placeholder="Document type" autofocus="true">
                    </form:input>
    ...
    <spring:bind path="documentdate">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="documentdate" class="form-control" placeholder="Document date" readonly>
                    </form:input>
